...
const accentStyles: Record<string, string> = {
  ...
  emerald: 'text-emerald-700 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-950/50',
...
export function MetricCard({ 
  ...
  return (
    ...
    >
      ...
      <div className="mt-4">
        <h3 className="text-sm font-medium text-zinc-600 dark:text-zinc-400 dark:text-zinc-400">{label}</h3>
